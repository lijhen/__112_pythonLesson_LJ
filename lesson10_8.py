...
options = st.selectbox('選擇行政區：',areas)
mask2 = df1['行政區']==options
df2 =mask_dataFrame[mask2]
st.write(options,':共',len(df2.index),'站')
st.dataframe(df2)

#[app] https://lijhen---112-pythonlesson-lj-lesson10-8-20dljz.streamlit.app/
